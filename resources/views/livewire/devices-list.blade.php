            ...
            @foreach ($this->devices as $device)            
                <tr class="bg-white border-b hover:bg-gray-50 dark:hover:bg-gray-100 cursor-pointer">
                    ...
                    <td class="w-60 px-6 py-4">
                        <div class="w-60 overflow-hidden overflow-ellipsis whitespace-nowrap text-sm">{{ $device->model }}</div>
                    </td>
                    ...
                    <td class="w-full px-6 py-4">
                        <div class="overflow-hidden overflow-ellipsis whitespace-nowrap text-base" style="width: 632px;">{{$device->location}}
                        </div>                        
                    </td>
                </tr>
            @endforeach
